    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("Vui lòng kiếm tra lại tài khoản/mật khẩu và xác thực email trước khi đăng nhập!");
                    return View(model);
                }
            }
            return View(model);
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> LoginAdmin(LoginViewModel model, string returnUrl = "/Admin/HomeAdmin/Index")
        {
            returnUrl ??= Url.Content("~/");
            ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
        ...
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> LogOffAdmin()
        {
            await _signInManager.SignOutAsync();
            _logger.LogInformation("User đăng xuất");
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new AppUser { UserName = model.UserName, Email = model.Email, NGAYDK = DateTime.Now, TENKH = model.TenKH, PhoneNumber = model.SDT, GIOITINH = model.GioiTinh };
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(model.Email,
                        ...
                        @$"Bạn đã đăng ký tài khoản trên shop thời trang, 
        ...
        [HttpGet("/account/verifyauthenticatorcode")]
        [AllowAnonymous]
        ...
        [HttpPost("/account/verifyauthenticatorcode")]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        ...
        [HttpGet("/account/userecoverycode/")]
        [AllowAnonymous]
        ...
        [HttpPost("/account/userecoverycode/")]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> UseRecoveryCode(UseRecoveryCodeViewModel model)
        {
            ...
            TempData["StatusMessage"] = "Đã nhận request từ client";
